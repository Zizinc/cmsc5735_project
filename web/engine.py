...
class SparkEngine:
    ...
    def load_csv_to_table(self):
        file_path = "hdfs://localhost:9000/yelp-dataset/yelp_business.csv"
        #file_path = "/home/ubuntu/Downloads/yelp-dataset/yelp_business.csv"
        yelpBusinessDf = self.spark.read \
            .csv(file_path, mode="DROPMALFORMED", header=True)
        yelpBusinessDf.registerTempTable("yelp_business")

        file_path = "hdfs://localhost:9000/yelp-dataset/yelp_review.csv"
        ...
        file_path = "hdfs://localhost:9000/yelp-dataset/yelp_user.csv"
        #file_path = "/home/ubuntu/Downloads/yelp-dataset/yelp_user.csv"
        yelpUserDf = self.spark.read \
            .csv(file_path, mode="DROPMALFORMED", header=True, multiLine=True)
        yelpUserDf.registerTempTable("yelp_user")

        file_path = "hdfs://master:9000/yelp-dataset/yelp_checkin.csv"
        #file_path = "/home/ubuntu/Downloads/yelp-dataset/yelp_checkin.csv"
